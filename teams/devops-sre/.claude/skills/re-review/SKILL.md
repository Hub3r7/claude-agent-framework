---
name: re-review
description: Re-run the review chain on existing code without implementing anything. Use when the user wants a fresh review of code that is already written.
...
4. Run the review chain for that tier, skipping design and implementation agents. Use only review agents from the team.
